                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('user.update', $user->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="father_name" type="text" class="form-control @error('father_name') is-invalid @enderror" name="father_name" value="{{ $user->father_name }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <img class="img-fluid small-image mt-3 mb-3" src="{{ url('/uploads/'. $user->profile_image) }}" alt="{{ $user->name }}" alt="{{ $user->name }}">
                                <span class="font-weight-bold text-danger bg-dark p-2">Your Old Image</span>
                                @error('profile_image')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
